...
export default function SisterConcernsPage() {
  return (
    <>
      <PageHero breadcrumbs={[{ label: "Sister Concerns" }]} image="/images/hero-construction-cranes-hd.webp" imageAlt="Modern construction site with tower cranes across Bangladesh" title="Our Group Companies" />
