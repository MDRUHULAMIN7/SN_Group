    ...
    <>
        ...
        <Container className="grid gap-14 lg:grid-cols-12 lg:items-center">
          <Reveal className="lg:col-span-6">
            ...
            <div className="mt-6 space-y-4 text-base leading-8 text-white/70">
              ...
              <p>
                Over the years, the Group has developed a diversified portfolio through three core businesses: <strong className="text-white">S.N Engineering &amp; Construction</strong>, <strong className="text-white">S.N Import &amp; Export</strong>, and <strong className="text-white">Mehrish Holdings</strong>.
              </p>
              <p>
          ...
          <Reveal className="relative lg:col-span-6" delay={0.1}>
            <div className="relative aspect-[5/4] overflow-hidden rounded-2xl border border-white/15 bg-navy shadow-2xl">
              <Image
            ...
            <span className="absolute -bottom-5 -left-5 hidden border border-cobalt/35 bg-black p-6 text-xs font-bold uppercase tracking-[0.13em] text-blue-300 sm:block">
              Dhaka · Bangladesh
            </span>
          </Reveal>
        </Container>
      ...
      <section className="blueprint-grid-dark border-t border-white/10 bg-black text-white section-space">
        <Container>
          ...
          <div className="mt-14 grid gap-px overflow-hidden rounded-2xl border border-white/12 bg-white/12 lg:grid-cols-3">
