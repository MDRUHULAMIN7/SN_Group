      ...
      <section className="border-t border-white/10 bg-black text-white section-space">
        <Container className="grid gap-14 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="mt-7 text-sm leading-7 text-white/58">For urgent site or operational matters, call the relevant project contact. For new enquiries, use the group details below.</p>
          </Reveal>
      ...
      <section className="blueprint-grid-dark border-t border-white/10 bg-black text-white section-space">
        <Container className="grid gap-14 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="mt-7 text-sm leading-7 text-white/58">A short but specific brief helps us route your request and prepare for a productive first conversation.</p>
          </Reveal>
          <Reveal className="rounded-2xl border border-white/12 bg-[#090b10] p-6 shadow-[0_22px_60px_rgba(0,0,0,0.32)] sm:p-10 lg:col-span-7 lg:col-start-6" delay={0.1}><ContactForm /></Reveal>
        </Container>
      </section>
    </>
  );
