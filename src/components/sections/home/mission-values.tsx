            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <span className="grid size-12 place-items-center rounded-full border border-cobalt/20 bg-white text-cobalt shadow-[0_8px_22px_rgba(21,94,239,0.08)] transition-[transform,background-color,color,border-color,box-shadow] duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-1 group-hover:scale-105 group-hover:border-cobalt group-hover:bg-cobalt group-hover:text-white group-hover:shadow-[0_12px_28px_rgba(21,94,239,0.20)]">
                ...
                <h3 className="display-type mt-7 text-2xl font-bold text-ink transition-colors duration-700 group-hover:text-cobalt">{value.title}</h3>
            ...
            {values.map((val, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="display-type mt-7 text-2xl font-bold text-ink transition-colors duration-700 group-hover:text-cobalt">{val.title}</h4>
