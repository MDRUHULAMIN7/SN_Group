...
export function ContactCta() {
  return (
    <section className="blueprint-grid relative overflow-hidden border-t border-slate-200 bg-white py-20 text-ink sm:py-28">
      ...
      <Container className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
        ...
        <Reveal delay={0.1}>
          <ButtonLink className="min-w-52" href="/contact#quotation-form" size="lg" variant="primary">Request a quotation <ArrowUpRight aria-hidden="true" className="size-5" /></ButtonLink>
        </Reveal>
      </Container>
    </section>
  );
