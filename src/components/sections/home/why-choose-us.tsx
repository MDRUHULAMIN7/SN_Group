          ...
          {pillars.map((pillar, index) => {
            ...
            return (
              <Reveal className="h-full" delay={index * 0.08} key={pillar.title}>
                <article className="why-card group relative flex h-full min-h-68 flex-col overflow-hidden rounded-xl border border-slate-200/90 bg-white p-7 shadow-[0_16px_38px_-12px_rgba(15,23,42,0.12),0_6px_16px_-4px_rgba(15,23,42,0.06)] transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-cobalt/40 hover:shadow-[0_24px_50px_-12px_rgba(21,94,239,0.22)] sm:p-8">
