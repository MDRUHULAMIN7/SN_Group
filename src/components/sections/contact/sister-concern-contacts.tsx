...
const concernContacts = [
  {
    ...
    emailHref: "mailto:info@sngroupbd.com",
  ...
  },
  {
    ...
    phoneHref: "tel:+8801335229070",
    email: "query@sngroupbd.com",
    emailHref: "mailto:query@sngroupbd.com",
    specialty: "Tiger Brand food products, agricultural commodities, industrial chemicals, machinery, and custom import orders.",
    tag: "Trade & Logistics",
  },
  {
