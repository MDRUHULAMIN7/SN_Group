...
export function FooterNavigation() {
  return (
    <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
      <div>
        <p className="mb-5 text-[0.65rem] font-bold uppercase tracking-[0.16em] text-ink/45">Navigate</p>
      ...
      <div className="col-span-1 sm:col-span-2">
        <p className="mb-5 text-[0.65rem] font-bold uppercase tracking-[0.16em] text-ink/45">Sister concerns</p>
        <ul className="space-y-3 text-sm text-ink/65">
