      ...
      >
        <div
          ...
          className={cn(
            ...
            compact && "h-17 max-w-[86rem] rounded-2xl border-white/15 bg-black/25 backdrop-blur-2xl shadow-[0_16px_45px_rgba(0,0,0,0.38)]",
          )}
        >
          ...
          <Link aria-label="S.N Group home" className={cn("relative z-10 rounded-xl px-1.5 py-1 transition-transform duration-800 ease-[cubic-bezier(0.16,1,0.3,1)]", compact && "scale-[0.9]")} href="/">
            <BrandLockup inverse markPlate size="sm" />
          </Link>
          <div className="relative z-10"><DesktopNavigation /></div>
          <div className="relative z-10 flex items-center gap-2">
            <ButtonLink className="hidden lg:inline-flex" href="/contact#quotation-form" size="sm" variant="light">
              Request a quotation
            </ButtonLink>
            <AnimatedMenuButton
